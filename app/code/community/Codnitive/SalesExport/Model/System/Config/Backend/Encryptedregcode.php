...
class Codnitive_SalesExport_Model_System_Config_Backend_Encryptedregcode extends Mage_Core_Model_Config_Data
{
    ...
    protected function _beforeSave()
    {
        ...
        if (empty($value)) {
            Mage::throwException(Mage::helper('salesexport')->__('%s is required.', 
                    Mage::helper('salesexport')->__($fieldConf->label)));
        }
        ...
        if (!$alnumValidator->isValid($value) || !$lenValidator->isValid($value)) {
            Mage::throwException(Mage::helper('salesexport')->__('%s is not valid.', 
                    Mage::helper('salesexport')->__($fieldConf->label)));
        }
