...
class Codnitive_SalesExport_Model_System_Config_Backend_Cert extends Mage_Core_Model_Config_Data
{
    ...
    protected function _beforeSave()
    {
        ...
        if ($value) {
            try {
                ...
                if ($condition) {
                    $err = Mage::helper('salesexport')->__('%s extension not registered.', 
                            Mage::helper('salesexport')->__(Codnitive_SalesExport_Model_Config::EXTENSION_NAME));
