...
class Codnitive_SalesExport_Helper_Data extends Mage_Core_Helper_Data
{
    ...
    {
        return Mage::getStoreConfig(Codnitive_SalesExport_Model_Config::getNamespace() . 'chkfrq');
    }

    public function getLastCheck()
    {
        $namespace = Codnitive_SalesExport_Model_Config::EXTENSION_NAMESPACE;
    ...
    {
        $nameSpace = Codnitive_SalesExport_Model_Config::getNamespace();
        ...
        try {
            ...
            $inf = array(
                ...
                'en' => base64_encode($crypt->encrypt((string)Codnitive_SalesExport_Model_Config::EXTENSION_NAME)),
                'ev' => base64_encode($crypt->encrypt((string)Codnitive_SalesExport_Model_Config::EXTENSION_VERSION)),
    ...
    public function getSalesSection()
    {
        ...
        if (key_exists('internal_invoice_ids', $params)) {
            return 'invoice';
        }
